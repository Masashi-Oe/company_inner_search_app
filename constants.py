...
SUPPORTED_EXTENSIONS = {
    ...
    ".txt": lambda path: TextLoader(path, encoding="utf-8")  # 追加(課題5)
}
...
# ドキュメント処理設定（追加：課題2）
# ==========================================
CHUNK_SIZE = 2000      # チャンク分割サイズ（文字数）課題6のため500から2000に変更
CHUNK_OVERLAP = 50    # チャンク重複サイズ（文字数）
RETRIEVER_K = 5       # 検索結果取得数(課題1)